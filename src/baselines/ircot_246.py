...
if __name__ == '__main__':
    ...
    if args.retriever == 'bm25':
        ...
        if args.dataset == 'hotpotqa':
            faiss_index = faiss.read_index('data/hotpotqa/hotpotqa_sentence-transformers_gtr-t5-base_ip_norm.index')
        elif args.dataset == 'musique':
            faiss_index = faiss.read_index('data/musique/musique_sentence-transformers_gtr-t5-base_ip_norm.index')
        elif args.dataset == '2wikimultihopqa':
