...
if __name__ == '__main__':
    ...
    if args.retriever == 'bm25':
        ...
        if norm:
            vector_path = f'data/{args.dataset}/{args.dataset}_{retriever_label}_vectors_norm.npy'
            index_path = f'data/{args.dataset}/{args.dataset}_{retriever_label}_ip_norm.index'
        else:
            vector_path = f'data/{args.dataset}/{args.dataset}_{retriever_label}_vectors.npy'
            index_path = f'data/{args.dataset}/{args.dataset}_{retriever_label}_ip.index'
