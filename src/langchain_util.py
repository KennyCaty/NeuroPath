...
def init_langchain_model(llm: str, model_name: str = "gpt-4o-mini", temperature: float = 0.0, max_retries=5, timeout=60, seed=42, **kwargs):
    """
    ...
    if llm == 'openai':
        ...
        return ChatOpenAI(api_key=os.environ.get("OPENAI_API_KEY"), base_url=os.environ.get("OPENAI_BASE_URL", "https://api.openai.com/v1"), model=model_name, temperature=temperature, max_retries=max_retries, timeout=timeout, seed=seed, **kwargs)
    elif llm == 'together':
